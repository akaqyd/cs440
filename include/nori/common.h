...
#define Scene_Max 1e9f
#define Scene_Boundary 1e5f
 ...
 * \brief Calculates the unpolarized fresnel reflection coefficient for a 
 * dielectric material. Handles incidence from either side (i.e.
 * \code cosThetaI<0 is allowed). In addition, this function also store cosThetaT.
 *
 * \param cosThetaI
 *      Cosine of the angle between the normal and the incident ray
 * \param extIOR
 ...
 *      Refractive index of the interior
 * \param cosThetaT
 *      Reference to store the cosine of the angle between the normal and the transmitted ray.
 */
extern float fresnel(float cosThetaI, float extIOR, float intIOR, float &cosThetaT);
