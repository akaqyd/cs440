...
NORI_NAMESPACE_BEGIN
    ...
    class RoughnessTexture: public NoriTexture{
private:
    float m_scale = 1.f;
    Bitmap m_texture;
    ...
    public:
        RoughnessTexture(const PropertyList &propList) {
...
//            return n;
        ...
        bool isRoughnessTexture() override {
            return true;
        }
    ...
    NORI_REGISTER_CLASS(RoughnessTexture, "roughness_texture");
NORI_NAMESPACE_END
