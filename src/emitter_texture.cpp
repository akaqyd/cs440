...
NORI_NAMESPACE_BEGIN
    ...
    class EmitterTexture: public NoriTexture{
private:
    float m_scale = 1.f;
    Bitmap m_texture;
    ...
    public:
        EmitterTexture(const PropertyList &propList) {
...
//            return n;
        ...
        bool isEmitterTexture() override {
            return true;
        }
    ...
    NORI_REGISTER_CLASS(EmitterTexture, "emitter_texture");
NORI_NAMESPACE_END
